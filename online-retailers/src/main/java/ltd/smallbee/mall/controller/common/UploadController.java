 ...
 * 版权所有，侵权必究！
 */
package ltd.smallbee.mall.controller.common;

import ltd.smallbee.mall.common.Constants;
import ltd.smallbee.mall.util.NewBeeMallUtils;
...
public class UploadController {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException {
        ...
        //生成文件名称通用方法
        //时间格式
        SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMMM_HHmmss");
        Random r = new Random();
        ...
        try{
            ...
            successResult.setData(NewBeeMallUtils.getHost(new URI(httpServletRequest.getRequestURI()+""))+"/upload/"+newFile);
