 ...
 * 版权所有，侵权必究！
 */
package ltd.smallbee.mall.common;

import org.springframework.util.ClassUtils;

public class Constants {
    //public final static String FILE_UPLOAD_DIC = "/opt/image/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    //public final static String FILE_UPLOAD_DIC = "D:\\Tmp\\goods-img\\";//上传文件的默认url前缀，根据部署设置自行修改
    public final static String FILE_UPLOAD_DIC = ClassUtils.getDefaultClassLoader().getResource("").getPath()
            + "static\\goods-img\\";
